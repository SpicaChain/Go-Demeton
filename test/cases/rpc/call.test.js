...
var protocol_version = '/deb/1.0.0'
...
deb.setRequest(new HttpRequest("http://54.149.15.132:8685"));
...
function verify(gas, testInput, done) {
    ...
    deb.api.getAccountState(sourceAccount.getAddressString()).then(function (state) {
        try {
...
describe('rpc: Call', function () {
    ...
    before ('send 10 deb to contract address', function (done) {
        nonce = nonce + 1;
