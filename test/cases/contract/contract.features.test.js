...
describe('test transfer from contract', function () {
    ...
    it ('1. test feature getAccoutState 1/2', function (done) {
        ...
        deb.api.call(sourceAccount.getAddressString(), contractAddress, Unit.nasToBasic(10), nonce, 200000, 1000000, contract).then(function(resp){
    ...
    it ('3. test feature getPreBlockHash 1/5[offset is 1]', function (done) {
        ...
        deb.api.call(sourceAccount.getAddressString(), contractAddress, Unit.nasToBasic(10), nonce, 200000, 1000000, contract).then(function(resp){
            ...
            return deb.api.getBlockByHeight(height - offset);
        }).then(function(resp) {
            // console.log(JSON.stringify(resp));
