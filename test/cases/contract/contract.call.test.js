...
function prepareContractCall(testCase, done) {
    deb.api.getAccountState(source.getAddressString()).then(function (resp) {
        ...
        var fromBalance = (typeof testCase.testInput.fromBalance === "undefined") ? deb.nasToBasic(1) : testCase.testInput.fromBalance;
                ...
                try {
                    if (true === testExpect.canSubmitTx) {
                        ...
                        deb.api.getAccountState(receipt.from).then(function (state) {
                            ...
                            return deb.api.getAccountState(contractAddr);
                        }).then(function (state) {
...
function checkNRCBalance(address, contractAddress) {
    ...
    deb.api.call(address, contractAddress, "0", 2, "1000000", "2000000", contract).then(function (resp) {
...
testCase = {
    ...
    "testExpect": {
        ...
        canExcuteTx: false,
        status: 0,
        fromBalanceAfterTx: deb.nasToBasic(1),
        toBalanceAfterTx: '0',
        transferReward: '0'
    }
};
