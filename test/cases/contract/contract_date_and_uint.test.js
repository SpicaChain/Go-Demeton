...
deb.setRequest(new HttpRequest(testnetConfig.apiEndPoint));
...
function deployContract(done, caseGroup) {
    ...
    deb.api.getAccountState(source.getAddressString()).then(function (resp) {
        ...
        accounts.push(from);
        var fromBalance = (typeof caseGroup.fromBalance === "undefined") ? deb.nasToBasic(1) : caseGroup.fromBalance;
...
function runTest(testInput, testExpect, done) {
    ...
    deb.api.getAccountState(to.getAddressString()).then(function (resp) {
