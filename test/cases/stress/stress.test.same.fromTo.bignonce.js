...
if (env === 'local') {
    ...
    //deb.setRequest(new HttpRequest("http://52.47.199.42:8685"));
    deb.setRequest(new HttpRequest("http://35.177.214.138:8685"));
    //deb.setRequest(new HttpRequest("http://13.127.227.177:8685"));
    ChainID = 1003;
    from = new Wallet.Account("25a3a441a34658e7a595a0eda222fa43ac51bd223017d17b420674fb6d0a4d52");
    ...
    deb.setRequest(new HttpRequest("http://34.208.233.164:8685"));
    ChainID = 1004;
    from = new Wallet.Account("25a3a441a34658e7a595a0eda222fa43ac51bd223017d17b420674fb6d0a4d52");
    ...
    deb.setRequest(new HttpRequest("http://35.154.108.11:8685"));
    ChainID = 1001;
    ...
    deb.setRequest(new HttpRequest("http://13.57.96.40:8685"));
    ChainID = 1001;
    from = new Wallet.Account("25a3a441a34658e7a595a0eda222fa43ac51bd223017d17b420674fb6d0a4d52");
    // from = new Wallet.Account("d2319a8a63b1abcb0cc6d4183198e5d7b264d271f97edf0c76cfdb1f2631848c");
...
function sendTransactionsForTps() {
    ...
    for (var i = 0; i < AddressNumber; i++) {
        ...
        deb.api.getAccountState(acc.getAddressString()).then(function (resp) {
