...
import (
	...
	byteutils "github.com/cyber-demeton/go-demeton/util/byteutils"
	"github.com/cyber-demeton/go-demeton/util/logging"
	"github.com/sirupsen/logrus"
)

/*
NebMessage defines protocol in Demeton, we define our own wire protocol, as the following:
...
// ParseNebMessage parse deb message
...
// ParseMessageData parse deb message data
