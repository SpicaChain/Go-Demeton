...
import (
	...
	"github.com/cyber-demeton/go-demeton/neblet"
...
func main() {
	...
	app.Usage = "the go-demeton command line interface"
	app.Copyright = "Copyright 2017-2018 The go-demeton Authors"
...
func deb(ctx *cli.Context) error {
	n, err := makeNeb(ctx)
	if err != nil {
		return err
	}
...
func runNeb(ctx *cli.Context, n *neblet.Deblet) chan bool {
...
func makeNeb(ctx *cli.Context) (*neblet.Deblet, error) {
