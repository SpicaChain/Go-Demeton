...
var (
	...
	// DvmMemoryLimitWithoutInjectHeight memory of dvm contract without inject code
	DvmMemoryLimitWithoutInjectHeight = TestNetNvmMemoryLimitWithoutInjectHeight
	...
	//DvmGasLimitWithoutTimeoutAtHeight
	DvmGasLimitWithoutTimeoutAtHeight = TestNetNvmGasLimitWithoutTimeoutAtHeight
)
...
func SetCompatibilityOptions(chainID uint32) {
	if chainID == MainNetID {
		...
		DvmMemoryLimitWithoutInjectHeight = MainNetNvmMemoryLimitWithoutInjectHeight
		...
		DvmGasLimitWithoutTimeoutAtHeight = MainNetNvmGasLimitWithoutTimeoutAtHeight
		...
		DvmMemoryLimitWithoutInjectHeight = LocalNvmMemoryLimitWithoutInjectHeight
		...
		DvmGasLimitWithoutTimeoutAtHeight = LocalNvmGasLimitWithoutTimeoutAtHeight
	}
	...
	logging.VLog().WithFields(logrus.Fields{
		...
		"DvmMemoryLimitWithoutInjectHeight":         NvmMemoryLimitWithoutInjectHeight,
		...
		"DvmGasLimitWithoutTimeoutAtHeight":         NvmGasLimitWithoutTimeoutAtHeight,
