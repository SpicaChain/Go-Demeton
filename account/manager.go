...
import (
	...
	"github.com/cyber-demeton/go-demeton/crypto/keystore/secp256k1/vrf/secp256k1VRF"
	...
	"github.com/cyber-demeton/go-demeton/crypto/cipher"
	"github.com/cyber-demeton/go-demeton/crypto/keystore"
	"github.com/cyber-demeton/go-demeton/crypto/utils"
...
func NewManager(neblet Deblet) (*Manager, error) {
	m := new(Manager)
