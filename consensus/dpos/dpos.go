...
// Metrics
var (
	metricsBlockPackingTime = metrics.NewGauge("deb.block.packing")
	metricsBlockWaitingTime = metrics.NewGauge("deb.block.waiting")
	metricsLruPoolSlotBlock = metrics.NewGauge("deb.block.lru.poolslot")
	metricsMintBlock        = metrics.NewCounter("deb.block.mint")
)
...
func (dpos *Dpos) Setup(neblet core.Deblet) error {
